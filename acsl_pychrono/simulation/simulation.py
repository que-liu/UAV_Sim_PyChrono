...
class Simulation:
  ...
  def addMotors(self):
    ...
    for i in range(8):
      ...
      # motor.SetMotorFunction(chrono.ChFunctionConst(5.0 * 2*math.pi))  # Uncomment if needed
  ...
  def applyWindForce(self, wind_force_vector: tuple[float, float, float], apply: bool = False):
    ...
    applicaion_point = chrono.ChVector3d(-0.006329836449057219, -0.05730872796244302, 3.945863912075595e-05)
    self.m_frame.AccumulateForce(0,
