...
def WrapperMain_function(target_folder, controller_type, wrapper_control_parameters, wrapper_foldername, wrapper_filename, max_simulation_time, csv_file_path_abnormalities, Wrapper_execution, visualization_flag):
   ...
   #%% Defining Wrapper control parameters and creating folders and files            
    ...
    controller_start_time = 10.1 # Time after the start of simulation at which the controller is switched ON
   ...
   # while vis.Run():
        if visualization_flag == True:
            ...
            vis.AddCamera(my_frame_pos_GLOB + chrono.ChVectorD(-0.8, 0.4, 0), my_frame_pos_GLOB) # MOVING CAMERA (-0.5, 0.2, 0)
        ...
        # Motor Failure#!!!
        if (time_now > 3):
            motor_efficiency_matrix = np.matrix(np.diag([1, 0, 1, 1, 1, 1, 1, 1]))
