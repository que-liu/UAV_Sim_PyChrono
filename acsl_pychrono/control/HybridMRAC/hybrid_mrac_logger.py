...
from acsl_pychrono.control.HybridMRAC.hybrid_mrac import HybridMRAC

class HybridMRACLogger:
  def __init__(self, gains: HybridMRACGains) -> None:
    self.gains = gains
    self.data_list = []
    # Length of the array vector that will be exported 
    self.size_DATA = 181

  def collectData(self, controller: HybridMRAC, simulation_time: float):
